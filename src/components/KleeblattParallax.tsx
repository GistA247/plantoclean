    ...
    <div ref={containerRef} className="relative" style={{ height: "400vh" }}>
      ...
      <div className="kleeblatt-pin h-screen w-full flex items-center justify-center overflow-hidden pointer-events-none">
        <svg
          ...
          height="275"
          viewBox="0 0 184 275"
          className="w-[40vw] max-w-[500px] will-change-transform"
        ...
        >
          ...
          {/* Layer 1: Shadow stem (deepest, slowest) */}
          <g data-depth="0.1">
            <path
          ...
          {/* Layer 2: Shadow leaves */}
          <g data-depth="0.2">
            <path d="M79.583,76.25c0,0 5.833,-6.667 10,-26.25c2.5,-11.25 5.417,-22.917 2.917,-30c-4.167,-10.833 -8.75,-13.333 -15.833,-14.583c-7.083,-1.25 -13.75,-1.667 -13.75,-1.667l-10,16.25l-22.5,-2.917c0,0 -3.333,8.333 -3.333,15.417c0,7.083 3.333,20 10.417,25c7.083,5 19.167,8.75 26.25,10.833c7.083,2.083 15.833,7.917 15.833,7.917Z" fill="#162b17" fillRule="nonzero" />
            <path d="M76.25,80c0,0 -6.667,-5.833 -26.25,-10.833c-11.25,-2.917 -23.75,-7.083 -30.417,-4.167c-8.333,3.75 -11.667,6.25 -15.417,14.167c-2.917,6.25 -4.167,10.833 -4.167,10.833l17.5,12.083l-3.333,17.083c0,0 11.667,10 18.75,10c7.083,0.417 16.667,-4.583 22.083,-10.833c5.417,-6.25 9.583,-17.5 12.083,-24.167c2.5,-6.25 9.167,-14.167 9.167,-14.167Z" fill="#162b17" fillRule="nonzero" />
            <path d="M78.75,80.833c0,0 -4.583,7.5 -6.667,27.917c-1.25,11.667 -2.5,24.167 0.417,30.833c5,10.417 9.583,12.5 16.667,12.917c7.083,0.417 13.333,0.417 13.333,0.417l7.917,-17.5l22.083,0.417c0,0 2.083,-8.75 1.25,-15.833c-0.833,-7.083 -5.417,-20 -12.917,-24.167c-7.5,-4.167 -19.167,-6.667 -26.25,-7.917c-6.667,-2.083 -15.833,-7.083 -15.833,-7.083Z" fill="#162b17" fillRule="nonzero" />
            <path d="M81.667,76.667c0,0 6.667,5.833 26.667,10.417c11.25,2.5 23.333,5.833 30.417,3.75c11.25,-3.333 13.333,-7.917 15,-14.583c1.667,-6.667 2.083,-12.917 2.083,-12.917l-15.833,-10.833l3.75,-21.667c0,0 -8.333,-3.333 -15.417,-3.333c-7.083,-0.417 -20.417,2.5 -25.833,9.167c-5.417,6.667 -9.167,17.917 -11.667,25c-2.5,6.667 -9.167,15 -9.167,15Z" fill="#162b17" fillRule="nonzero" />
          </g>
          ...
          {/* Layer 4: Back leaves (top + left) */}
          <g data-depth="0.5">
            <path d="M80.417,72.083c0,0 5.833,-6.667 10,-26.25c2.5,-11.25 5.417,-22.917 2.917,-30c-3.75,-10.833 -8.75,-12.917 -15.833,-14.167c-7.083,-1.25 -13.75,-1.667 -13.75,-1.667l-10,16.25l-22.5,-2.917c0,0 -3.333,8.333 -3.333,15.417c0,7.083 3.333,20 10.417,25c7.083,5 19.167,8.75 26.25,10.833c7.083,2.083 15.833,7.5 15.833,7.5Z" fill="url(#p_Linear2)" fillRule="nonzero" />
            <path d="M77.5,75.833c0,0 -6.667,-5.833 -26.25,-10.833c-11.25,-2.917 -23.75,-7.083 -30.417,-4.167c-8.333,3.75 -11.667,6.25 -15.417,14.167c-2.917,6.25 -4.167,10.833 -4.167,10.833l17.5,12.083l-3.333,17.083c0,0 11.667,10 18.75,10c7.083,0.417 16.667,-4.583 22.083,-10.833c5.417,-6.25 9.583,-17.5 12.083,-24.167c2.5,-5.833 9.167,-14.167 9.167,-14.167Z" fill="url(#p_Linear3)" fillRule="nonzero" />
          </g>

          {/* Layer 5: Front leaves (bottom + right) */}
          <g data-depth="0.8">
            <path d="M79.583,77.083c0,0 -4.583,7.5 -6.667,27.917c-1.25,11.667 -2.5,24.167 0.417,30.833c5,10.417 9.583,12.5 16.667,12.917c7.083,0.417 13.333,0.417 13.333,0.417l7.917,-17.5l22.5,0c0,0 2.083,-8.75 1.25,-15.833c-0.833,-7.083 -5.417,-20 -12.917,-24.167c-7.5,-4.167 -19.167,-6.667 -26.25,-7.917c-7.083,-1.667 -16.25,-6.667 -16.25,-6.667Z" fill="url(#p_Linear4)" fillRule="nonzero" />
            <path d="M82.917,72.5c0,0 6.667,5.833 26.667,10.417c11.25,2.5 23.333,5.833 30.417,3.75c11.25,-3.333 13.333,-7.917 15,-14.583c1.667,-6.667 2.083,-12.917 2.083,-12.917l-16.25,-10.417l3.75,-21.667c0,0 -8.333,-3.333 -15.417,-3.333c-7.083,-0.417 -20.417,2.5 -25.833,9.167c-5.417,6.667 -9.167,17.917 -11.667,25c-2.5,6.25 -8.75,14.583 -8.75,14.583Z" fill="url(#p_Linear5)" fillRule="nonzero" />
          </g>
        </svg>
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="h-screen" /> {/* First screen: just the clover */}
